...
<%
  ...
  while(itr.hasNext()) {
    ...
    if(key.equals(attrFindNumber) && "true".equalsIgnoreCase(fnRequired) || key.equals(attrQuantity) || key.equals(attrUsage) || key.equals(attrRef) && "true".equalsIgnoreCase(rdRequired)) {
%>
    <tr>
